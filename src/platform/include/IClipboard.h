...
public:
    ...
    ///   - a custom "application/x-dexilate-svg-path" type for Dexilate-to-Dexilate paste
    ...
    /// Prefers the "application/x-dexilate-svg-path" type; falls back to plain SVG text.
